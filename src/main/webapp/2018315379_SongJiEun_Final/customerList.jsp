...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="top-menu">
      ...
      <a id="logoutM" type="button" name="button" href="mainPage.jsp">Log out</a>
    </div>
    <div class="listBox">
      <center>
...
<%
    try{
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/memberlist?" + "user=root&password=root");
